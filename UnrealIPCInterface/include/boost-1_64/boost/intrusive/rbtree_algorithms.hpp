...
//! but also to the leftmost node of the tree, to instantiate_shared_mem constant time
//! begin(), and to the rightmost node of the tree, to instantiate_shared_mem linear time
