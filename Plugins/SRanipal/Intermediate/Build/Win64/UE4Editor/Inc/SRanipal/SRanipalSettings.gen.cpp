...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USRanipalSettings_Statics::NewProp_EyeVersion = { "EyeVersion", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USRanipalSettings, EyeVersion), Z_Construct_UEnum_SRanipal_SupportedEyeVersion, METADATA_PARAMS(Z_Construct_UClass_USRanipalSettings_Statics::NewProp_EyeVersion_MetaData, ARRAY_COUNT(Z_Construct_UClass_USRanipalSettings_Statics::NewProp_EyeVersion_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USRanipalSettings_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_USRanipalSettings_Statics::PropPointers),
		0,
		0x001000A6u,
		METADATA_PARAMS(Z_Construct_UClass_USRanipalSettings_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_USRanipalSettings_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(USRanipalSettings, 2265631169);
